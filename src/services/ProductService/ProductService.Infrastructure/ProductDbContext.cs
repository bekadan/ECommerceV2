...
/// </summary>
internal sealed class ProductDbContext : DbContext, IDbContext, IUnitOfWork
{
    ...
    public ProductDbContext(DbContextOptions<ProductDbContext> options, IDateTime dateTime)
        : base(options)
    {
        _dateTime = dateTime;
    }
